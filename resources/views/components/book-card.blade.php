<div data-aos="fade-in" data-aos-duration="1500" id="book-card" class="mx-auto md:mx-0 w-64 sm:w-56 bg-darkcolor text-center text-lightcolor rounded-md shadow-2xl">    
    <a href="{{ route('books.show', $book['id']) }}">
        <img src="/storage/images/{{ $book['file_path'] }}" alt="book-img" class="hover:opacity-80 object-cover w-80 sm:w-56 h-64 rounded-t-md">
    </a>
